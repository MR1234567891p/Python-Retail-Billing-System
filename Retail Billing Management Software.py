...
class Bill_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Billing Software", bd=12, relief=GROOVE, fg=fg_color, bg=bg_color,
                      font=("times new roman", 35, "bold"), pady=3).pack(fill=X)
        ...
        cname_lbl = Label(F1, text="Customer Name", bg=bg_color, fg=fg_color,
                          font=("times new roman", 20, "bold")).grid(row=0, column=0, padx=10, pady=5)
        cname_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.cus_name)
        cname_en.grid(row=0, column=1, ipady=4, ipadx=30, pady=5)

        # =================Customer Phone==============#
        cphon_lbl = Label(F1, text="Phone No", bg=bg_color, fg=fg_color, font=("times new roman", 20, "bold")).grid(
            row=0, column=2, padx=20)
        cphon_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.c_phone)
        cphon_en.grid(row=0, column=3, ipady=4, ipadx=30, pady=5)

        # ====================Customer Bill No==================#
        cbill_lbl = Label(F1, text="Bill No.", bg=bg_color, fg=fg_color, font=("times new roman", 20, "bold"))
        ...
        F2.place(x=5, y=180, width=screen_width/3, height=456)
        ...
        # ========Hair Shampoo
        hair_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Hair Shampoo")
        hair_lbl.grid(row=3, column=0, padx=10, pady=20)
        hair_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.hair_shampoo)
        ...
        # ============Hair Oil
        bu_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Hair Oil")
        bu_lbl.grid(row=5, column=0, padx=10, pady=20)
        bu_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.hair_oil)
        bu_en.grid(row=5, column=1, ipady=5, ipadx=5)

        # ==================Grocery Frame=====================#
        F2 = LabelFrame(self.root, text='Grocery', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 24, "bold"))
        F2.place(x=330, y=180, width=screen_width/3, height=456)
        ...
        # ============
        tea_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Tea")
        tea_lbl.grid(row=5, column=0, padx=10, pady=20)
        tea_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.tea)
        tea_en.grid(row=5, column=1, ipady=5, ipadx=5)

        # ==================Other Stuff=====================#

        F2 = LabelFrame(self.root, text='Others', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 24, "bold"))
        F2.place(x=655, y=180, width=screen_width/3, height=456)

        # ===========Frame Content
        mojo_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Mojo")
        mojo_lbl.grid(row=0, column=0, padx=10, pady=20)
        mojo_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.mojo)
        mojo_en.grid(row=0, column=1, ipady=5, ipadx=5)

        # =======
        drinko_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Drinko")
        drinko_lbl.grid(row=1, column=0, padx=10, pady=20)
        drinko_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.drinko)
        drinko_en.grid(row=1, column=1, ipady=5, ipadx=5)

        # =======
        frooto_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Frooto")
        frooto_lbl.grid(row=2, column=0, padx=10, pady=20)
        frooto_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.frooto)
        frooto_en.grid(row=2, column=1, ipady=5, ipadx=5)

        # ========
        cold_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Nimki")
        cold_lbl.grid(row=3, column=0, padx=10, pady=20)
        cold_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.nimki)
        cold_en.grid(row=3, column=1, ipady=5, ipadx=5)

        # ============
        ch_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Chanachur")
        ch_lbl.grid(row=5, column=0, padx=10, pady=20)
        ch_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.chanachur)
        ch_en.grid(row=5, column=1, ipady=5, ipadx=5)
        ...
        F3.place(x=960, y=180, width=screen_width/3, height=456)
        # ===========
        ...
        F4 = LabelFrame(self.root, text='Bill Menu', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 24, "bold"))
        F4.place(x=0, y=636, relwidth=1, height=200)
    ...
    def total(self):
        ...
        self.total_cosmetics_prices = (
                ...
                (self.hair_shampoo.get() * 340) +
                (self.body_lotion.get() * 260)+
                (self.hair_oil.get() * 160)
                
        )
        self.total_cosmetics.set("Tk. " + str(self.total_cosmetics_prices))
        self.tax_cos.set("Tk. " + str(round(self.total_cosmetics_prices * 0.05)))
        ...
        self.total_grocery.set("Tk. " + str(self.total_grocery_prices))
        self.tax_groc.set("Tk. " + str(round(self.total_grocery_prices * 0.05)))
        # ======================Total Other Prices
        self.total_other_prices = (
                ...
                (self.frooto.get() * 60) +
                (self.nimki.get() * 20) +
                (self.chanachur.get() * 80)+
                (self.biscuits.get() * 30) 
        )
        self.total_other.set("Tk. " + str(self.total_other_prices))
        self.tax_other.set("Tk. " + str(round(self.total_other_prices * 0.05)))

    # Function For Text Area
    def welcome_soft(self):
        self.txt.delete('1.0', END)
        self.txt.insert(END, "       Welcome To MMS's Retail\n")
    ...
    def bill_area(self):
        ...
        if self.hair_shampoo.get() != 0:
            self.txt.insert(END, f"\nHair Shampoo      {self.hair_shampoo.get()}           {self.hair_shampoo.get() * 340}")
        if self.body_lotion.get() != 0:
            self.txt.insert(END, f"\nBody Lotion       {self.body_lotion.get()}           {self.body_lotion.get() * 260}")
        if self.hair_oil.get() != 0:
            self.txt.insert(END, f"\nHair Oil          {self.hair_oil.get()}           {self.hair_oil.get() * 160}")     
        if self.wheat.get() != 0:
        ...
        if self.tea.get() != 0:
            self.txt.insert(END, f"\nTea               {self.tea.get()}           {self.tea.get() * 100}")
        if self.mojo.get() != 0:
            self.txt.insert(END, f"\nMojo              {self.mojo.get()}           {self.mojo.get() * 20}")
        if self.drinko.get() != 0:
            self.txt.insert(END, f"\nDrinko            {self.drinko.get()}           {self.drinko.get() * 50}")
        if self.frooto.get() != 0:
            self.txt.insert(END, f"\nFrooto            {self.frooto.get()}           {self.frooto.get() * 60}")
        if self.nimki.get() != 0:
            self.txt.insert(END, f"\nNimki             {self.nimki.get()}           {self.nimki.get() * 20}")
        if self.chanachur.get() != 0:
            self.txt.insert(END, f"\nChanachur         {self.chanachur.get()}           {self.chanachur.get() * 80}")
        if self.biscuits.get() != 0:
            self.txt.insert(END, f"\nBiscuits          {self.biscuits.get()}           {self.biscuits.get() * 30}")
